...
export const createDepartmentAction = (department) => async (dispatch) => {
    ...
    try {
        const res = await axios.post(`${process.env.REACT_APP_API_URL}/department`, department)
...
export const updateDeaprtmentAction = (id, data) => async (dispatch) => {
    ...
    try {
        const res = await axios.patch(`${process.env.REACT_APP_API_URL}/department/${id}`, data)
