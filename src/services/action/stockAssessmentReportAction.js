...
export const createStockAssessmentReports = (values, cb) => async(dispatch) => {
    dispatch({
        type: STOCK_ASSESSMENT_REPORT_REQUEST,
    });
...
export const updateStockAssessmentReports = (id, values, cb) => async(dispatch) => {
    dispatch({
        type: STOCK_ASSESSMENT_REPORT_REQUEST,
    });
...
export const deleteStockAssessmentReports = (params, cb) => async(dispatch) => {
    dispatch({
        type: STOCK_ASSESSMENT_REPORT_REQUEST,
    });
