                        ...
                        <Table stickyHeader className="table table-dark table-md" style={{ backgroundColor: '#d0cfcf', border: '1px solid grey' }} >
                            ...
                            <TableBody >
                                <StyledTableRow >
                                    ...
                                    <StyledTableCell className="text-dark" align="center">Heavy Truck</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">Arsalan</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">0303-0303030</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">41303-222222-2</StyledTableCell>
                                ...
                                <StyledTableRow >
                                    ...
                                    <StyledTableCell className="text-dark" align="center">ABC-123</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">Truck</StyledTableCell>
