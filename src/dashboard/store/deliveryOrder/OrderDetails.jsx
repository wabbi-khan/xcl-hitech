        ...
        <Sidenav title={'Order Details'}>
            <div>
                ...
                <Container className={classes.mainContainer1}>
                    <Grid container className="text-center" spacing={1} style={{ marginTop: 15, }} >
                        <Grid item lg={3} md={3} sm={12} xs={12}>
                            <p style={{ display: 'inline' }}>Fittings Required</p>
                            <Button variant="contained" className="btn" disabled
                                    style={{ backgroundColor: '#00af00', color: 'whitesmoke', fontSize: 12, display: 'inline', marginLeft: 15 }}
                            >
                                Yes
                            </Button>
                        </Grid>
                        <Grid item lg={3} md={3} sm={12} xs={12}>
                            ...
                            <Button variant="contained" className="btn" disabled
                                    style={{ backgroundColor: 'red', color: 'whitesmoke', fontSize: 12, display: 'inline', marginLeft: 15 }}
                            >
                                No
                            </Button>
                        </Grid>
