                                ...
                                <Grid container spacing={1} style={{ marginTop: 15 }}>
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.grNo && props.errors.grNo}
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.issueSide && props.errors.issueSide}
                                            error={props.touched.issueSide && props.errors.issueSide}
                                        >
                                ...
                                <Grid container spacing={1} style={{ marginTop: 10 }}>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.DSR && props.errors.DSR}
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.dept && props.errors.dept}
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.itemName && props.errors.itemName}
                                            error={props.touched.itemName && props.errors.itemName}
                                        >
                                            <MenuItem value=""></MenuItem>
                                        </CssTextField>
                                    </Grid>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.itemCode && props.errors.itemCode}
                                            error={props.touched.itemCode && props.errors.itemCode}
                                        />
                                    </Grid>
                                </Grid>
                                <Grid container spacing={1} style={{ marginTop: 10 }}>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.partyName && props.errors.partyName}
                                            error={props.touched.partyName && props.errors.partyName}
                                        />
                                    </Grid>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.minInv && props.errors.minInv}
                                            error={props.touched.minInv && props.errors.minInv}
                                        />
                                    </Grid>
                                </Grid>
                            </Form>
                                ...
                                <Grid container spacing={1} style={{ marginTop: 10 }}>
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.issueQty && props.errors.issueQty}
                                            error={props.touched.issueQty && props.errors.issueQty}
                                        />
                                    </Grid>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                ...
                                <Grid container spacing={1} style={{ marginTop: 10 }}>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.balance && props.errors.balance}
                                            error={props.touched.balance && props.errors.balance}
                                        />
                                    </Grid>
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.reply && props.errors.reply}
                                    ...
                                    <Grid item lg={3} md={3} sm={12} xs={12}>
                                        <CssTextField
                                            ...
                                            helperText={props.touched.mcName && props.errors.mcName}
                                            error={props.touched.mcName && props.errors.mcName}
                                        />
                                    </Grid>
                                </Grid>
                                <Grid container spacing={1} style={{ marginTop: 10 }}>
