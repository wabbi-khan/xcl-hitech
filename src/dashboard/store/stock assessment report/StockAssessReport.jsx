                        ...
                        <Table stickyHeader className="table table-dark" style={{ backgroundColor: '#d0cfcf', border: '1px solid grey' }} >
                            <TableHead>
                                <TableRow hover role="checkbox">
                                    ...
                                    <StyledTableCell align="center">Item Retains Its Properties</StyledTableCell>
                                    <StyledTableCell align="center">OK for Further Use</StyledTableCell>
                                    <StyledTableCell align="center">Rejected/To Be Discarded</StyledTableCell>
                            ...
                            <TableBody >
                                <StyledTableRow >
                                    ...
                                    <StyledTableCell className="text-dark" align="center">230</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">34</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">OK</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">OK</StyledTableCell>
                                    <StyledTableCell className="text-dark" align="center">Not Good</StyledTableCell>
