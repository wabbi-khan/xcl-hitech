                ...
                <Grid container spacing={1} style={{ marginTop: 15 }}>
                  <Grid item lg={4} md={4} sm={12} xs={12}>
                    <CssTextField
                      ...
                      helperText={
                        props.touched.inwardType && props.errors.inwardType
                      }
                      error={
                        props.touched.inwardType && props.errors.inwardType
                      }
                ...
                <Grid container spacing={1} style={{ marginTop: 15 }}>
                  <Grid item lg={3} md={3} sm={12} xs={12}>
                    <CssTextField
                      ...
                      helperText={
                        props.touched.vehicleNo && props.errors.vehicleNo
                      }
                  ...
                  <Grid item lg={3} md={3} sm={12} xs={12}>
                    <CssTextField
                      ...
                      helperText={props.touched.through && props.errors.through}
                      error={props.touched.through && props.errors.through}
                    />
                  </Grid>
                  <Grid item lg={3} md={3} sm={12} xs={12}>
                    <CssTextField
