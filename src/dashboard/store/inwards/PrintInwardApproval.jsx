                    ...
                    <table class='table table-inverse table-responsive table-bordered border-dark mt-4'>
                        <thead class='thead-inverse'>
                            <tr>
                                ...
                                <td style={{ fontSize: '12px', fontWeight: 'bold' }}>Qty. Received</td>
                                <td style={{ fontSize: '12px', fontWeight: 'bold' }}>Qty. Approved</td>
                                <td style={{ fontSize: '12px', fontWeight: 'bold' }}>Qty. Rejected</td>
                                <td style={{ fontSize: '12px', fontWeight: 'bold' }}>Dept.</td>
                                <td style={{ fontSize: '12px', fontWeight: 'bold' }}>Rejection Reason</td>
...
export default PrintInwardApproval
