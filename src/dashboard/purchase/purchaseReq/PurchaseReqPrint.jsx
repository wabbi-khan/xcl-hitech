    ...
    return (
        <div className="text-center">
            ...
            <div className={classes.table}>
                <div className="table ml-auto mr-auto mt-4" style={{ marginTop: 'auto', marginBottom: 'auto', }}>
                    <TableContainer>
                        <Table>
                            <TableHead>
                            ...
                            <TableBody >
                                <StyledTableRow >
                                    ...
                                    <StyledTableCell className="text-dark" align="center">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. At fugit consequatur
                                    </StyledTableCell>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col=lg-2 col-md-2 offset-lg-2 offset-md-2">
                        <hr style={{ backgroundColor: 'black', paddingTop: 2 }} />
                        <p style={{ marginTop: -10 }}>Purchase Officer</p>
                    </div>
                    <div className="col=lg-2 col-md-2 offset-lg-2 offset-md-2">
