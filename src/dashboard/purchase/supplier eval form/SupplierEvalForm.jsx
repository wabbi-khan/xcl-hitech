											...
											return (
												<Form autoComplete="off">
													...
													<Container className={classes.mainContainer}>
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>a. Incoming stage?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12}>
																<CssTextField
																	id='outlined-basic'
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>b. In process state?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12}>
																<CssTextField
																	id='outlined-basic'
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>c. Final state?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12}>
																<CssTextField
																	id='outlined-basic'
										...
										(props) => {
											...
											return (
												<Form autoComplete="off">
													...
													<p className='text-center'>To be completed by the Purchasing Department</p>
													<Container className={classes.mainContainer}>
														<Grid container spacing={1} style={{ marginTop: 15 }}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12}>
																<h6 className={classes.questinOne}>
																	1. For how long has the supplier been providing goode/services to the company?
																</h6>
															</Grid>
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>a. Quality requirements?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
																	id='outlined-basic'
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>b. On time delivery?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
																	id='outlined-basic'
														...
														<Grid container spacing={1}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>c. After sales services?</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
																	id='outlined-basic'
														...
														<Grid container spacing={1} style={{ marginTop: 15 }}>
															...
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.3rem' }}>
																<CssTextField
																	id='outlined-basic'
																	label='Ans'
																	variant='outlined'
										...
										(props) => {
											...
											return (
												<Form autoComplete="off">
													...
													<p className='text-center'>To be completed by the Auditor/Representative</p>
													<Container className={classes.mainContainer}>
														<Grid container spacing={1} style={{ marginTop: 15 }}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12}>
										...
										(props) => {
											...
											return (
												<Form autoComplete="off">
													...
													<p className='text-center'>TO BE FILLED BY QUALITY ASSURANCE DEPARTMENT</p>
													<Container className={classes.mainContainer}>
														<Grid container spacing={1} style={{ marginTop: 15 }}>
															<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
															<Grid item lg={8} md={8} sm={12} xs={12}>
														...
														<Grid container spacing={1}>
															...
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>
																	a. Quality(Total lots passes/Total lots supplied + Qty Passes/Qty Supplied) / 2x60 = 60
																</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
														...
														<Grid container spacing={1}>
															...
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>
																	b. On Time Delivery: Marks Detected @ 3 Marks Per Day Late Delivery. = 30
																</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
														...
														<Grid container spacing={1}>
															...
															<Grid item lg={8} md={8} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<h6 className={classes.questinOne} style={{ marginLeft: '3rem' }}>
																	c. Price: Maximum Marks (i.e. 10) / (Unit price/lower unit price) = 10
																</h6>
															</Grid>
															<Grid item lg={2} md={3} sm={12} xs={12} style={{ marginTop: '0.5rem' }}>
																<CssTextField
																...
																(props) => {
																	...
																	return (
																		<Form autoComplete="off">
																			...
																			<p className='text-center'>To be completed by Director Finance, Procurement and Admin</p>
																			<Container className={classes.mainContainer}>
																				<Grid container spacing={1} style={{ marginTop: 15 }}>
																					<Grid item lg={2} md={2} sm={12} xs={12}></Grid>
																					<Grid item lg={8} md={8} sm={12} xs={12}>
