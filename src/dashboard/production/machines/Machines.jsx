...
const [inputFields, setInputFields] = useState({name: '', code: '', date: sortedDate})
                                            ...
                                            (
                                                machines.length ?
                                                    machines.map((machine, i) => (
                                                        <StyledTableRow>
                                                            <StyledTableCell className="text-dark bg-light" align="center">{i + 1}</StyledTableCell>
                                                            <StyledTableCell className="text-dark bg-light" align="center">{machine.name}</StyledTableCell>
                                                            <StyledTableCell className="text-dark bg-light" align="center">{machine.code}</StyledTableCell>
