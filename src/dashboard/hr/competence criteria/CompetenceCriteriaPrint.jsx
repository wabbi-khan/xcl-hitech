    ...
    return (
        <div className="text-center">
            <div className="container">
                ...
                <h5 className="mt-4" style={{ textDecorationLine: 'underline', }}>COMPETENCE CRITERIA</h5>
            </div>
            ...
            <Grid container spacing={1} style={{ marginTop: 120 }} >
                <Grid item lg={3} md={3} sm={3} xs={3}>
                    ...
                    <p style={{ marginTop: -10, fontSize: 12, fontWeight: 'bold' }}>Admin In-Charge</p>
                </Grid>
