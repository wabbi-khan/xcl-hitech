                                                ...
                                                >
                                                    {
                                                        !departments || !departments.length ? <p>Data Not Found</p> :
                                                            departments.map(dept => (
                                                                <MenuItem value={dept._id} key={dept._id}>{dept.name}</MenuItem>
                                                            ))
                                                    }
                                                </CssTextField>
                                            </Grid>
                                                ...
                                                >
                                                    {
                                                        !skills || !skills.length ? <p>Data Not Found</p> :
                                                            skills.map(skill => (
                                                                <MenuItem value={skill._id} key={skill._id}>{skill.skill}</MenuItem>
                                                            ))
                                                    }
                                                </CssTextField>
                                            </Grid>
                                            <Grid lg={12} md={12} sm={12} className="mt-3">
                                                ...
                                                </CssTextField>
                                                {
                                                    isUpdate ? <p className="text-success mt-1">Competence Criteria Update Success</p> : (
                                                        isError ? <p className="text-danger mt-1">Competence Criteria Update Failed</p> : null
                                                    )
                                                }
                                            </Grid>
                                        </Grid>
