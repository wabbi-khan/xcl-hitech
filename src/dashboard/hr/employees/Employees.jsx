                  ...
                  <Grid container spacing={1}>
                    ...
                    <Grid item lg={3} md={3} sm={12} xs={12}>
                      <CssTextField
                        ...
                        helperText={
                          props.touched.telephoneNo && props.errors.telephoneNo
                        }
                        error={
                          props.touched.telephoneNo && props.errors.telephoneNo
                        }
                  ...
                  <Grid container spacing={1} style={{ marginTop: 15 }}>
                    ...
                    <Grid item lg={3} md={3} sm={12} xs={12}>
                      <CssTextField
                        ...
                        helperText={
                          props.touched.division && props.errors.division
                        }
                            ...
                            >
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  color="secondary"
                                  onClick={() =>
                                    deleteAcademicQualification(el.id)
                                  }
                            ...
                            >
                              ...
                              >
                                <Button
                                  ...
                                  classNames="bg-dark text-light"
                                  onClick={() =>
                                    editProfessionalQualification(el)
                                  }
                                />
                                <Button
                                  variant="contained"
                                  ...
                                  color="secondary"
                                  onClick={() =>
                                    deleteProfessionalQualification(el.id)
                                  }
                                  style={{ marginLeft: "1rem" }}
                                />
                              </div>
                  ...
                  <Grid container spacing={1} style={{ marginTop: 15 }}>
                    ...
                    <Grid item lg={3} md={3} sm={12} xs={12}>
                      <CssTextField
                        ...
                        helperText={
                          props.touched.lastSalary && props.errors.lastSalary
                        }
                        error={
                          props.touched.lastSalary && props.errors.lastSalary
                        }
