        ...
        <div>
            <div className="text-center">
                <div className="container">
                    ...
                    <h5 className="mt-4" style={{ textDecoration: 'underline', fontWeight: 'bold' }}>Training Record and Evaluation</h5>
                </div>
                        ...
                        <table class="table table-striped table-inverse table-bordered table-responsive table-hover">
                            <thead class="thead-inverse">
                                <tr>
                                    ...
                                    <th>Evaluated By</th>
                                    <th>Training Evaluation Result</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
