                            ...
                            {fields.map((field) => {
                              return (
                                <CustomInput
                                  ...
                                  value={el[field.name]}
                                  onBlur={form.handleBlur(`values[${i}][${field.name}]`)}
                                  helperText={form.touched.values && form.errors.values && form.errors.values[i]&& form.errors.values[i][field.name]}
                                  error={form.touched.values && form.errors.values && form.errors.values[i]&& form.errors.values[i][field.name]}
                                  onChange={(e) => handleChange(e, form, field,i)}
                                />
                              );
                            })}
                          </div>
